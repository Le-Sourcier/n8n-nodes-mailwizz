...
class Lists extends Request_1.default {
     ...
     */
    create({ name, description, fromName, fromEmail, replyTo, subject, notificationSubscribe, notificationUnsubscribe, notificationSubscribeTo, notificationUnsubscribeTo, companyName, companyCountry, companyZone, companyAddress1, companyAddress2, companyZoneName, companyCity, companyZipCode }) {
        let postData = {
            //required
            general: {
                name: name, //required
     ...
     */
    update({ listID, name, description, fromName, fromEmail, replyTo, subject, notificationSubscribe, notificationUnsubscribe, notificationSubscribeTo, notificationUnsubscribeTo, companyName, companyCountry, companyZone, companyAddress1, companyAddress2, companyZoneName, companyCity, companyZipCode }) {
        let postData = {
            //required
            general: {
                name: name, //required
